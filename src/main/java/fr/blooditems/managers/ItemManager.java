...
public class ItemManager {
    ...
    public ItemStack createItem(String id) {
        ...
        return switch (id.toLowerCase()) {
            ...
            case "farm_helmet" ->
                    create(Material.DIAMOND_HELMET,
                            "§aCasque de Farm",
                            id);

            case "farm_chestplate" ->
                    create(Material.DIAMOND_CHESTPLATE,
                            "§aPlastron de Farm",
                            id);

            case "farm_leggings" ->
                    create(Material.DIAMOND_LEGGINGS,
                            "§aPantalon de Farm",
                            id);

            case "farm_boots" ->
                    create(Material.DIAMOND_BOOTS,
                            "§aBottes de Farm",
                            id);


            case "blood_helmet" ->
                    create(Material.NETHERITE_HELMET,
                            "§cCasque Blood",
                            id);

            case "blood_chestplate" ->
                    create(Material.NETHERITE_CHESTPLATE,
                            "§cPlastron Blood",
                            id);

            case "blood_leggings" ->
                    create(Material.NETHERITE_LEGGINGS,
                            "§cPantalon Blood",
                            id);

            case "blood_boots" ->
                    create(Material.NETHERITE_BOOTS,
                            "§cBottes Blood",
                            id);


            case "hammer" ->
                    create(Material.NETHERITE_PICKAXE,
                            "§6Hammer 3x3",
                            id);
